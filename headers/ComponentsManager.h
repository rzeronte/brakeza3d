...
public:
    ...
    ComponentCamera     *getComponentCamera() { return static_cast<ComponentCamera *>(components[ComponentID::COMPONENT_CAMERA]); };
    ComponentCollisions *getComponentCollisions() { return static_cast<ComponentCollisions *>(components[ComponentID::COMPONENT_COLLISIONS]); };
    ComponentMenu       *getComponentMenu() { return static_cast<ComponentMenu *>(components[ComponentID::COMPONENT_MENU]); };
    ComponentWeapons    *getComponentWeapons() { return static_cast<ComponentWeapons *>(components[ComponentID::COMPONENT_WEAPONS]); };
    ...
    ComponentWindow     *getComponentWindow() { return static_cast<ComponentWindow *>(components[ComponentID::COMPONENT_WINDOW]); };
    ComponentGUI        *getComponentGUI() { return static_cast<ComponentGUI *>(components[ComponentID::COMPONENT_GUI]); };
    ComponentRender     *getComponentRender() { return static_cast<ComponentRender *>(components[ComponentID::COMPONENT_RENDER]); };
    ComponentInput      *getComponentInput() { return static_cast<ComponentInput *>(components[ComponentID::COMPONENT_INPUT]); };
    ComponentGame       *getComponentGame() { return static_cast<ComponentGame *>(components[ComponentID::COMPONENT_GAME]); };
    ComponentGameInput  *getComponentGameInput() { return static_cast<ComponentGameInput *>(components[ComponentID::COMPONENT_GAME_INPUT]); };
};
