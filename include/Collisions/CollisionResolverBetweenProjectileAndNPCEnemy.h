...
public:
    ...
    CollisionResolverBetweenProjectileAndNPCEnemy(btPersistentManifold *contactManifold, Object3D *objA, Object3D *objB,
    ...
    void dispatch() {
        ...
        Tools::playMixedSound(EngineBuffers::getInstance()->soundPackage->getSoundByLabel(
                "bloodHit" + std::to_string(Tools::random(1, 3))), EngineSetup::SoundChannels::SND_BLOOD_HIT, 0);
    }
