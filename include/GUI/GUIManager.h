    ...
    void RenderMenu(bool &finish)
    {
        ...
        if (ImGui::BeginMainMenuBar()) {
            ...
            if (ImGui::BeginMenu("Testing")) {
                ImGui::DragScalar("Testing value1", ImGuiDataType_Float, &EngineSetup::get()->TESTING_INT1, range_frustum_clipping_distance_sensibility, &range_min_framerate_distance, &range_max_fov, "%f", 1.0f);
                ImGui::DragScalar("Testing value2", ImGuiDataType_Float, &EngineSetup::get()->TESTING_INT2, range_frustum_clipping_distance_sensibility, &range_min_framerate_distance, &range_max_fov, "%f", 1.0f);
                ImGui::DragScalar("Testing value3", ImGuiDataType_Float, &EngineSetup::get()->TESTING_INT3, range_frustum_clipping_distance_sensibility, &range_min_framerate_distance, &range_max_fov, "%f", 1.0f);
                ImGui::DragScalar("Testing value4", ImGuiDataType_Float, &EngineSetup::get()->TESTING_INT4, range_frustum_clipping_distance_sensibility, &range_min_framerate_distance, &range_max_fov, "%f", 1.0f);
                ImGui::EndMenu();
            }
