...
void GUIAddonToolbar::Draw()
{
    ...
    if (ImGui::Begin("MainToolBar")) {
        LUAStatusIcons();
        VerticalSeparator();
        GUI::DrawButton("Enable/Disable UI", IconGUI::GUI, GUIType::Sizes::ICONS_TOOLBAR, Config::get()->ENABLE_IMGUI,[]() {
...
void GUIAddonToolbar::LayoutIcons()
{
    ...
    GUI::DrawButton("Default Layout", IconGUI::LAYOUT_DEFAULT, GUIType::Sizes::ICONS_TOOLBAR, window->getImGuiConfig() == Config::ImGUIConfigs::DEFAULT, [&]() {
        window->setImGuiConfig(Config::ImGUIConfigs::DEFAULT);
    });
    ImGui::SameLine();
    GUI::DrawButton("Developer Layout", IconGUI::LAYOUT_CODING, GUIType::Sizes::ICONS_TOOLBAR, window->getImGuiConfig() == Config::ImGUIConfigs::CODING, [&]() {
        window->setImGuiConfig(Config::ImGUIConfigs::CODING);
    });
    ImGui::SameLine();
    GUI::DrawButton("Design Layout", IconGUI::LAYOUT_DESIGN, GUIType::Sizes::ICONS_TOOLBAR, window->getImGuiConfig() == Config::ImGUIConfigs::DESIGN,[&]() {
...
void GUIAddonToolbar::TransformationsToolsIcons()
{
    ...
    GUI::DrawButton("Translate", IconGUI::TRANSLATE, GUIType::Sizes::ICONS_TOOLBAR, operation == ImGuizmo::OPERATION::TRANSLATE, [&]() {
        window->setGuiZmoOperation(ImGuizmo::OPERATION::TRANSLATE);
    });
    ImGui::SameLine();
    GUI::DrawButton("Rotate", IconGUI::ROTATE, GUIType::Sizes::ICONS_TOOLBAR, operation == ImGuizmo::OPERATION::ROTATE, [&]() {
        window->setGuiZmoOperation(ImGuizmo::OPERATION::ROTATE);
    });
    ImGui::SameLine();
    GUI::DrawButton("Scale", IconGUI::SCALE, GUIType::Sizes::ICONS_TOOLBAR, operation == ImGuizmo::OPERATION::SCALE_X, [&]() {
...
{
    GUI::DrawButton("Enable/Disable physic world", IconGUI::GRAVITY, GUIType::Sizes::ICONS_TOOLBAR, Config::get()->ENABLE_BULLET_STEP_SIMULATION, [&]() {
        GUI::Toggle(Config::get()->ENABLE_BULLET_STEP_SIMULATION);
    } );
    ImGui::SameLine();
    GUI::DrawButton( "Draw collider AABB", IconGUI::DRAW_COLLIDERS, GUIType::Sizes::ICONS_TOOLBAR, Config::get()->BULLET_DEBUG_MODE, [&]() {
...
{
    GUI::DrawButton("Enable/Disable item click selection", IconGUI::CLICK, GUIType::Sizes::ICONS_TOOLBAR, Config::get()->MOUSE_CLICK_SELECT_OBJECT3D, [&]() {
        GUI::Toggle(Config::get()->MOUSE_CLICK_SELECT_OBJECT3D);
    });
    ImGui::SameLine();
    GUI::DrawButton("Enable/Disable mouse look", IconGUI::MOUSE_LOOK, GUIType::Sizes::ICONS_TOOLBAR, Config::get()->MOUSE_LOOK,[&]() {
...
{
    GUI::DrawButton("Enable/Disable mouse look", IconGUI::LIGHT_SYSTEM, GUIType::Sizes::ICONS_TOOLBAR, Config::get()->ENABLE_LIGHTS,
       [&]() { GUI::Toggle(Config::get()->ENABLE_LIGHTS); }
    );

    if (Config::get()->ENABLE_LIGHTS) {
        ImGui::SameLine();
        GUI::DrawButton("Enable/Disable Light System", IconGUI::SHADOW_MAPPING, GUIType::Sizes::ICONS_TOOLBAR, Config::get()->ENABLE_SHADOW_MAPPING,[&]() {
...
void GUIAddonToolbar::LUAStatusIcons()
{
    ...
    ImGui::SameLine();
    GUI::DrawButton("Reload scripts", IconGUI::RELOAD, GUIType::Sizes::ICONS_TOOLBAR, false, [&]() { scripting->ReloadLUAScripts(); });
    ImGui::SameLine();
    GUI::DrawButton("Clear scene", IconGUI::REMOVE, GUIType::Sizes::ICONS_TOOLBAR, false, [&]() { SceneLoader::ClearScene(); });
}
