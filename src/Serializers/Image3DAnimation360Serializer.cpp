...
{
    LOG_MESSAGE("[Image3DAnimation8DirectionsSerializer] JsonByObject: %d", o->getTypeObject());
...
{
    LOG_MESSAGE("[Image3DAnimation8DirectionsSerializer] ApplyJsonToObject: %d", o->getTypeObject());
